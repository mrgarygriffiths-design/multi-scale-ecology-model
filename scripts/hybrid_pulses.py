...
df.to_csv('hybrid_pulses_results.csv', index=False)
...
plt.title('Hybrid Pulses Novelty (5 Seeds)')
plt.legend()
plt.savefig('hybrid_pulses_novelty.png')
plt.close()

print("Done! Check 'hybrid_pulses_results.csv' and 'hybrid_pulses_novelty.png'")
